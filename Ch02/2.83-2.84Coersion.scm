...
(define (install-complex-package)
  ...
  (put 'complex-specific-op '(complex complex complex)
    (lambda (x y z)
      (make-integer (+ (real-part x) (real-part y) (real-part z)))))
...
(define a (make-complex-from-real-imag 2 20))
(define b (make-rational 20 20))
(define c (make-real 20))

(complex-specific-op c b a)
